...
#
# Created: Sun Jul 14 15:43:51 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.lbl_VS_revenge, 5, 4, 1, 1)
        self.lbl_TR_revenge = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_TR_revenge.setObjectName("lbl_TR_revenge")
        self.gridLayout_2.addWidget(self.lbl_TR_revenge, 4, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_NC_revenge_value, 3, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_TR_revenge_value, 4, 5, 1, 1)
        self.lbl_NC_revenge = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_NC_revenge.setObjectName("lbl_NC_revenge")
        self.gridLayout_2.addWidget(self.lbl_NC_revenge, 3, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_VS_revenge_value, 5, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_VS_dominations_value, 5, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_TR_dominations_value, 4, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_NC_domination_value, 3, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_dominations_value, 2, 7, 1, 1)
        self.lbl_revenge = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_revenge.setObjectName("lbl_revenge")
        self.gridLayout_2.addWidget(self.lbl_revenge, 2, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_revenge_value, 2, 5, 1, 1)
        self.lbl_assists = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_assists.setObjectName("lbl_assists")
        self.gridLayout_2.addWidget(self.lbl_assists, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lbl_assists_value, 0, 7, 1, 1)
        self.lbl_apm = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_apm.setObjectName("lbl_apm")
        self.gridLayout_2.addWidget(self.lbl_apm, 1, 4, 1, 1)
        self.lbl_apm_value = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_apm_value.setText("")
        self.lbl_apm_value.setObjectName("lbl_apm_value")
        self.gridLayout_2.addWidget(self.lbl_apm_value, 1, 5, 1, 1)
        self.lbl_aph = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_aph.setObjectName("lbl_aph")
        self.gridLayout_2.addWidget(self.lbl_aph, 1, 6, 1, 1)
        self.lbl_aph_value = QtGui.QLabel(self.gridLayoutWidget_2)
        self.lbl_aph_value.setText("")
        self.lbl_aph_value.setObjectName("lbl_aph_value")
        self.gridLayout_2.addWidget(self.lbl_aph_value, 1, 7, 1, 1)
...
"Count:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lbl_apm.setText(QtGui.QApplication.translate("MainWindow", "Assists Per Minute:", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_aph.setText(QtGui.QApplication.translate("MainWindow", "Assists Per Hour:", None, QtGui.QApplication.UnicodeUTF8))
